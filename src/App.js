...
class App extends Component {
  ...
  onClickThumbnail = thumbnailUrl => {
    ...
    const image = imagesList.find(eachImage => eachImage.imageUrl === imgUrl)
    const thumbnail = imagesList.find(
  ...
  playGame = () => {
    ...
    return (
      <div className="game-container">
        <img className="match-image" src={imgUrl} alt="match" />
  ...
  render() {
    const {score, time, isGameContinue} = this.state
